...
// FindScheduleForSpaceAt provides a mock function for the type MockActivityRepositoryInterface
func (_mock *MockActivityRepositoryInterface) FindScheduleForSpaceAt(ctx context.Context, spaceID string, now time.Time) (*entities.Activity, error) {
	ret := _mock.Called(ctx, spaceID, now)

	if len(ret) == 0 {
		panic("no return value specified for FindScheduleForSpaceAt")
	}

	var r0 *entities.Activity
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, time.Time) (*entities.Activity, error)); ok {
		return returnFunc(ctx, spaceID, now)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, time.Time) *entities.Activity); ok {
		r0 = returnFunc(ctx, spaceID, now)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entities.Activity)
		}
...
// MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FindScheduleForSpaceAt'
type MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call struct {
	*mock.Call
}

// FindScheduleForSpaceAt is a helper method to define mock.On call
//   - ctx context.Context
//   - spaceID string
//   - now time.Time
func (_e *MockActivityRepositoryInterface_Expecter) FindScheduleForSpaceAt(ctx interface{}, spaceID interface{}, now interface{}) *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call {
	return &MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call{Call: _e.mock.On("FindScheduleForSpaceAt", ctx, spaceID, now)}
}

func (_c *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call) Run(run func(ctx context.Context, spaceID string, now time.Time)) *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call) Return(activity *entities.Activity, err error) *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call {
	_c.Call.Return(activity, err)
	return _c
}

func (_c *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call) RunAndReturn(run func(ctx context.Context, spaceID string, now time.Time) (*entities.Activity, error)) *MockActivityRepositoryInterface_FindScheduleForSpaceAt_Call {
	_c.Call.Return(run)
	return _c
}

// HasScheduleOverlap provides a mock function for the type MockActivityRepositoryInterface
func (_mock *MockActivityRepositoryInterface) HasScheduleOverlap(ctx context.Context, spaceID string, startsAt time.Time, endsAt time.Time, excludeActivityID *string) (bool, error) {
	ret := _mock.Called(ctx, spaceID, startsAt, endsAt, excludeActivityID)

	if len(ret) == 0 {
		panic("no return value specified for HasScheduleOverlap")
	}

	var r0 bool
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, time.Time, time.Time, *string) (bool, error)); ok {
		return returnFunc(ctx, spaceID, startsAt, endsAt, excludeActivityID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, time.Time, time.Time, *string) bool); ok {
		r0 = returnFunc(ctx, spaceID, startsAt, endsAt, excludeActivityID)
	} else {
		r0 = ret.Get(0).(bool)
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, time.Time, time.Time, *string) error); ok {
		r1 = returnFunc(ctx, spaceID, startsAt, endsAt, excludeActivityID)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockActivityRepositoryInterface_HasScheduleOverlap_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasScheduleOverlap'
type MockActivityRepositoryInterface_HasScheduleOverlap_Call struct {
	*mock.Call
}

// HasScheduleOverlap is a helper method to define mock.On call
//   - ctx context.Context
//   - spaceID string
//   - startsAt time.Time
//   - endsAt time.Time
//   - excludeActivityID *string
func (_e *MockActivityRepositoryInterface_Expecter) HasScheduleOverlap(ctx interface{}, spaceID interface{}, startsAt interface{}, endsAt interface{}, excludeActivityID interface{}) *MockActivityRepositoryInterface_HasScheduleOverlap_Call {
	return &MockActivityRepositoryInterface_HasScheduleOverlap_Call{Call: _e.mock.On("HasScheduleOverlap", ctx, spaceID, startsAt, endsAt, excludeActivityID)}
}

func (_c *MockActivityRepositoryInterface_HasScheduleOverlap_Call) Run(run func(ctx context.Context, spaceID string, startsAt time.Time, endsAt time.Time, excludeActivityID *string)) *MockActivityRepositoryInterface_HasScheduleOverlap_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockActivityRepositoryInterface_HasScheduleOverlap_Call) Return(b bool, err error) *MockActivityRepositoryInterface_HasScheduleOverlap_Call {
	_c.Call.Return(b, err)
	return _c
}

func (_c *MockActivityRepositoryInterface_HasScheduleOverlap_Call) RunAndReturn(run func(ctx context.Context, spaceID string, startsAt time.Time, endsAt time.Time, excludeActivityID *string) (bool, error)) *MockActivityRepositoryInterface_HasScheduleOverlap_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockActivityRepositoryInterface) ListManagerSchedule(ctx context.Context, actorUserID uint64, global bool) ([]entities.PublicActivity, error) {
	...
	var r0 []entities.PublicActivity
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint64, bool) ([]entities.PublicActivity, error)); ok {
		return returnFunc(ctx, actorUserID, global)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uint64, bool) []entities.PublicActivity); ok {
...
func (_c *MockActivityRepositoryInterface_ListManagerSchedule_Call) Return(publicActivitys []entities.PublicActivity, err error) *MockActivityRepositoryInterface_ListManagerSchedule_Call {
	_c.Call.Return(publicActivitys, err)
	return _c
}

func (_c *MockActivityRepositoryInterface_ListManagerSchedule_Call) RunAndReturn(run func(ctx context.Context, actorUserID uint64, global bool) ([]entities.PublicActivity, error)) *MockActivityRepositoryInterface_ListManagerSchedule_Call {
	_c.Call.Return(run)
	return _c
}
