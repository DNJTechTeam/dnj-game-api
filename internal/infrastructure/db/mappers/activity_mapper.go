...
func MapActivityEntityToModel(entity *entities.Activity) *models.Activity {
	...
	return &models.Activity{ID: entity.ID, SpaceID: entity.SpaceID, Slug: entity.Slug, Name: entity.Name, Description: entity.Description, Kind: string(entity.Kind), Status: string(entity.Status), StartsAt: entity.StartsAt, EndsAt: entity.EndsAt, CheckInPoints: entity.CheckInPoints, MomentPoints: entity.MomentPoints, CooldownSeconds: entity.CooldownSeconds, AllowsMoment: entity.AllowsMoment, CreatedAt: entity.CreatedAt, UpdatedAt: entity.UpdatedAt}
}
